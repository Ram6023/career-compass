...
export const translations: Translations = {
  ...
  hi: {
    ...
    "hero.description":
      "उन्नत AI द्वारा संचालित, हम आपकी रुचियों, कौशल और शैक्षणिक पृष्ठभूमि का विश्लेषण करते हैं ताक��� आपके अनूठे प्रोफाइल से पूर्णतः मेल खाने वाले करियर की सिफारिश कर सकें। आज ही अपनी संतुष्टिजनक और सफल करियर की यात्��ा शुरू करें।",
    ...
    "assessment.description":
      "उन्नत आर्टिफिशियल इंटेलिजेंस द्वारा संचालित व्यक्तिगत करियर सिफारिशें प्राप्त करने के लिए कुछ प्रश्नों के उत्तर दें",
    ...
    "loading.description":
      "कृपया प्रतीक्षा करें जबकि हम आपकी व्यक्तिगत करियर सिफारिशें तैयार करते हैं",

    // Results
    "results.title": "आपकी व्यक्तिगत करियर सिफारिशें",
    "results.description":
      "आपके प्रो��ाइल विश्लेषण के आधार पर, यहाँ आपके लिए तैयार किए गए शीर्ष करियर पथ हैं",
  ...
  te: {
    ...
    "hero.description":
      "అధునాతన AI ద్వారా శక్తివంతం, మేము మీ అభిరుచులు, నైపుణ్యాలు మరియు అకాడెమిక్ నేపథ్యాన్ని విశ్లేషించి మీ ప్రత్యేక ప్రొఫైల్‌తో పూర్తిగా సరిపో��ే కెరీర్‌లను సిఫార్సు చేస్తాము. సంతృప్తికరమైన మరియు విజయవంతమైన కెరీర్ వైపు మీ ప్రయాణాన్ని ఈరోజే ప్రారంభించండి.",
    ...
    "assessment.description":
      "వ్యక్తిగత AI-ఆధారిత కెరీర్ సిఫార్సులను పొందడానికి ఈ సమగ్ర అసెస్‌మెంట్‌ను పూర్తి చేయ���డి",
    ...
    "assessment.careerGoalPlaceholder":
      "మీరు ఎప్పుడు ప్రారంభించాలనుకుంటున్నారు?",
    ...
    "loading.description":
      "మేము ��ీ వ్యక్తి��త కెరీర్ సిఫార్సులను రూపొందిస్తున్నప్పుడు దయచేసి వేచి ఉండండి",

    // Results
    "results.title": "మీ వ్యక్తిగత కెరీర్ సిఫార్సులు",
    "results.description":
      "మీ ప్రొఫైల్ విశ్లేషణ ఆధారంగా, మీ కోసం రూపొందించిన అగ్ర కెరీర్ మార్గాలు ఇవి",
