            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-gray-900 dark:text-white">
                    {stats.assessmentsCompleted.toLocaleString()}
                  </p>
                  <div className="flex items-center mt-2">
                    <CheckCircle className="h-4 w-4 text-green-500 mr-1" />
                    <span className="text-sm text-green-600">
                      {(
                        (stats.assessmentsCompleted / stats.totalStudents) *
                        100
                      ).toFixed(1)}
                      % completion
                    </span>
        ...
        <Tabs defaultValue="students" className="space-y-6">
          ...
          <TabsContent value="careers" className="space-y-6">
            <Card className="shadow-xl">
              <CardHeader>
                <CardTitle className="text-xl">
                  Career Popularity Trends
                </CardTitle>
                <CardDescription>
                  Most popular career choices among students
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-400">
                            {career.count} students interested
                          </p>
                        </div>
                      </div>
                      <div className="text-right">
              ...
              {streamAnalytics.map((stream) => (
                <Card key={stream.stream} className="shadow-lg">
                  <CardHeader>
                    ...
                    <CardDescription>
                      {stream.students} students enrolled
                    </CardDescription>
                  </CardHeader>
                    ...
                    <div className="flex items-start space-x-3 p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-green-600 dark:text-green-400">
                          AI model updated with latest data
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-blue-600 dark:text-blue-400">
                          Database optimization on Jan 25, 2AM-4AM
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3 p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-yellow-600 dark:text-yellow-400">
                          Increased usage during assessment period
                        </p>
                      </div>
                    </div>
                  </div>
