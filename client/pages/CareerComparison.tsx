...
const CAREERS: Career[] = [
  {
    ...
    description:
      "Analyze complex data to help organizations make informed decisions using statistical analysis and machine learning.",
    icon: BarChart3,
  ...
  },
  {
    ...
    description:
      "Create user-centered designs for digital products, focusing on user experience and interface design.",
    icon: Palette,
    averageSalary: "₹9 LPA",
  ...
  },
  {
    ...
    description:
      "Develop mobile applications for iOS and Android platforms using native or cross-platform frameworks.",
    icon: Smartphone,
...
export default function CareerComparison() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-zinc-100 dark:from-slate-900 dark:via-gray-900 dark:to-zinc-900">
      <Header pageSubtitle="Career Comparison" />
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-8">
            Make informed career decisions by comparing different career paths
            side-by-side. Analyze skills, salaries, growth prospects, and more.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto mb-12">
          <Card className="shadow-2xl">
            <CardHeader>
              ...
              <CardDescription>
                Choose two careers from our database to see a detailed
            ...
            <CardContent>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Select
                    value={selectedCareers[0] || ""}
                    onValueChange={(value) => handleCareerSelect(value, 0)}
                  >
                    ...
                    <SelectContent>
                      {CAREERS.map((career) => (
                        <SelectItem
                          key={career.id}
                          value={career.id}
                          disabled={career.id === selectedCareers[1]}
                        >
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    value={selectedCareers[1] || ""}
                    onValueChange={(value) => handleCareerSelect(value, 1)}
                  >
                    <SelectTrigger className="h-12">
                    ...
                    <SelectContent>
                      {CAREERS.map((career) => (
                        <SelectItem
                          key={career.id}
                          value={career.id}
                          disabled={career.id === selectedCareers[0]}
                        >
                          <div className="flex items-center space-x-3">
                            <career.icon className="h-4 w-4" />
                            <span>{career.title}</span>
                        ...
                        <div className="space-y-3">
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center space-x-2">
                              <Progress
                                value={career.workLifeBalance * 10}
                                className="w-20 h-2"
                              />
                              <span className="text-sm font-medium">
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center space-x-2">
                              <Progress
                                value={career.remoteFriendly * 10}
                                className="w-20 h-2"
                              />
                              <span className="text-sm font-medium">
                                {career.remoteFriendly}/10
                              </span>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center space-x-2">
                              <Progress
                                value={career.marketDemand * 10}
                                className="w-20 h-2"
                              />
                              <span className="text-sm font-medium">
                                {career.marketDemand}/10
                              </span>
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <div className="font-medium text-gray-900 text-center">
                        {getSelectedCareerData(0)?.title}
                      </div>
                      <div className="font-medium text-gray-900 text-center">
                        {getSelectedCareerData(1)?.title}
                      </div>
                      ...
                      <div
                        className={`text-center p-2 rounded ${getScoreColor(
                          getComparisonScore(
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                      {[getSelectedCareerData(0), getSelectedCareerData(1)].map(
                        (career, index) =>
                          career && (
                            <div key={index} className="space-y-4">
                              ...
                              <div className="space-y-3">
                                <div>
                                  <h5 className="font-medium text-green-700 text-sm mb-2">
                                    Pros
                                  </h5>
