...
Report generated by CareerCompass AI Career Recommendation System
  ...
  return (
    <div className="min-h-screen vibrant-bg relative overflow-hidden">
      {/* Decorative elements */}
      <div className="absolute top-20 left-10 w-20 h-20 bg-gradient-to-r from-pink-400 to-purple-500 rounded-full opacity-20 float-animation"></div>
      <div className="absolute top-40 right-20 w-16 h-16 bg-gradient-to-r from-blue-400 to-cyan-500 rounded-full opacity-20 float-animation" style={{animationDelay: '2s'}}></div>
      <div className="absolute bottom-20 left-1/4 w-12 h-12 bg-gradient-to-r from-green-400 to-blue-500 rounded-full opacity-20 float-animation" style={{animationDelay: '4s'}}></div>
      <div className="absolute bottom-40 right-1/3 w-14 h-14 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-full opacity-20 float-animation" style={{animationDelay: '1s'}}></div>
      {/* Enhanced Header */}
      <header className="border-b border-white/30 matte-glass sticky top-0 z-50">
          ...
          <div className="flex items-center justify-between">
            <Link to="/" className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-white/90 font-medium">{t('header.subtitle')}</p>
              </div>
            </Link>
            <nav className="hidden md:flex items-center space-x-8">
              <Link to="/careers" className="text-white/90 hover:text-white transition-all duration-300 font-medium hover:scale-105">{t('header.explorecareers')}</Link>
              <Link to="/resume-analyzer" className="text-white/90 hover:text-white transition-all duration-300 font-medium hover:scale-105">{t('header.resumeAnalyzer')}</Link>
              <Link to="/roadmaps" className="text-white/90 hover:text-white transition-all duration-300 font-medium hover:scale-105">{t('header.careerRoadmaps')}</Link>
              <Link to="/chat" className="text-white/90 hover:text-white transition-all duration-300 font-medium hover:scale-105">{t('header.aiAssistant')}</Link>
            </nav>
            <div className="flex items-center space-x-4">
              ...
              <Button variant="ghost" asChild className="text-white/90 hover:text-white hover:bg-white/20 transition-all duration-300">
                <Link to="/login">{t('header.login')}</Link>
              </Button>
              <Button asChild className="bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 hover:from-pink-600 hover:via-purple-600 hover:to-indigo-600 shadow-xl text-white font-semibold colorful-hover pulse-color">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight drop-shadow-lg">
            {t('hero.title')}
            <span className="gradient-text block font-black">
              {t('hero.subtitle')}
            </span>
          </h1>
          <p className="text-xl md:text-2xl text-white/95 max-w-4xl mx-auto mb-8 leading-relaxed drop-shadow">
            {t('hero.description')}
            <br className="hidden md:block" />
            <span className="text-yellow-300 font-bold">{t('hero.cta')}</span>
          </p>
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            <Badge className="px-6 py-3 text-sm badge-vibrant float-animation font-semibold">
              <Target className="w-4 h-4 mr-2" />
              {t('stats.accuracy')}
            </Badge>
            <Badge className="px-6 py-3 text-sm badge-ocean float-animation font-semibold" style={{animationDelay: '1s'}}>
              <Users className="w-4 h-4 mr-2" />
              {t('stats.students')}
            </Badge>
            <Badge className="px-6 py-3 text-sm badge-sunset float-animation font-semibold" style={{animationDelay: '2s'}}>
        ...
        {isLoading ? (
          ...
          <Card className="max-w-2xl mx-auto matte-glass colorful-hover">
            <CardContent className="p-8 text-center">
              <div className="mb-6">
                <div className="relative w-24 h-24 mx-auto">
                  ...
                  <div className="absolute inset-2 bg-white/20 backdrop-blur-md rounded-full"></div>
                  <div className="absolute inset-4 bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500 rounded-full flex items-center justify-center pulse-color">
                    <Brain className="h-8 w-8 text-white" />
                  </div>
                </div>
              </div>
              <h3 className="text-2xl font-bold text-white mb-4 drop-shadow">
                <span className="gradient-text">AI is Analyzing Your Profile</span>
              </h3>
              ...
              <div className="flex items-center justify-center space-x-2">
                <span className="text-white/80 text-sm font-medium">{loadingProgress}% Complete</span>
          ...
          <Card className="max-w-5xl mx-auto matte-glass interactive-card">
            <CardHeader className="bg-gradient-to-r from-purple-500/20 via-pink-500/20 to-blue-500/20 border-b border-white/30">
              <CardTitle className="flex items-center space-x-3 text-2xl text-white drop-shadow float-animation">
                <div className="p-3 bg-gradient-to-br from-purple-500 via-pink-500 to-blue-500 rounded-xl pulse-color">
                  <GraduationCap className="h-6 w-6 text-white" />
                </div>
                <span className="gradient-text font-bold">Career Assessment</span>
              </CardTitle>
            ...
            <CardContent className="p-8">
              <form onSubmit={handleSubmit} className="space-y-10">
                ...
                <div className="space-y-6">
                  <h3 className="text-xl font-semibold text-white flex items-center drop-shadow float-animation">
                    <BookOpen className="h-5 w-5 mr-2 text-yellow-300" />
                    <span className="gradient-text">Academic Background</span>
                  </h3>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <Label htmlFor="stream" className="text-base font-medium text-white/90">Academic Stream</Label>
                      <Select value={formData.stream} onValueChange={(value) => setFormData(prev => ({ ...prev, stream: value }))}>
                        <SelectTrigger className="h-12 matte-glass text-white border-white/30">
                          <SelectValue placeholder="Select your academic stream" className="text-white/70" />
                        </SelectTrigger>
                        <SelectContent>
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="cgpa" className="text-base font-medium text-white/90">CGPA / Percentage</Label>
                      <Input
                        id="cgpa"
                        type="number"
                        step="0.1"
                        ...
                        className="h-12 matte-glass text-white border-white/30 placeholder:text-white/60"
                      />
                    </div>
                  </div>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <Label htmlFor="experience" className="text-base font-medium text-white/90">Experience Level</Label>
                      <Select value={formData.experience} onValueChange={(value) => setFormData(prev => ({ ...prev, experience: value }))}>
                        <SelectTrigger className="h-12 matte-glass text-white border-white/30">
                          <SelectValue placeholder="Select your experience level" className="text-white/70" />
                        </SelectTrigger>
                        <SelectContent>
                ...
                <div className="space-y-6">
                  <h3 className="text-xl font-semibold text-white flex items-center drop-shadow float-animation">
                    <TrendingUp className="h-5 w-5 mr-2 text-cyan-300" />
                    <span className="gradient-text">Your Skills ({formData.skills.length} selected)</span>
                  </h3>
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    {SKILLS.map((skill) => (
                      <div key={skill} className="flex items-center space-x-3 p-3 matte-glass rounded-lg colorful-hover transition-all duration-300">
                        <Checkbox
                          id={`skill-${skill}`}
                        ...
                        <Label
                          htmlFor={`skill-${skill}`}
                          className="text-sm font-medium cursor-pointer flex-1 text-white/90"
                        >
                          {skill}
                        </Label>
                      </div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {formData.skills.map((skill) => (
                        <Badge
                          key={skill}
                          variant="secondary"
                          className="cursor-pointer badge-vibrant hover:scale-105 transition-all duration-200 float-animation"
                          onClick={() => {
                            toggleSkill(skill);
                            toast({
                              title: "Skill removed",
                ...
                <div className="space-y-6">
                  <h3 className="text-xl font-semibold text-white flex items-center drop-shadow float-animation">
                    ...
                    <span className="gradient-text">Your Interests ({formData.interests.length} selected)</span>
                  </h3>
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    {INTERESTS.map((interest) => (
                      <div key={interest} className="flex items-center space-x-3 p-3 matte-glass rounded-lg colorful-hover transition-all duration-300">
                        <Checkbox
                    ...
                    <div className="flex flex-wrap gap-2">
                      {formData.interests.map((interest) => (
                        <Badge
                          key={interest}
                          variant="outline"
                          className="cursor-pointer badge-ocean hover:scale-105 transition-all duration-200 float-animation"
                          onClick={() => {
                ...
                <Button
                  type="submit"
                  className="w-full py-6 text-lg bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500 hover:from-purple-600 hover:via-pink-600 hover:to-blue-600 shadow-xl text-white font-bold colorful-hover pulse-color"
          ...
          <div className="max-w-7xl mx-auto space-y-8">
            <div className="text-center">
              <h2 className="text-4xl font-bold text-white mb-4 drop-shadow-lg">
                <span className="gradient-text">Your Personalized Career Recommendations</span>
              </h2>
              ...
              <div className="flex justify-center space-x-4">
                <Button
                  ...
                  className="matte-glass text-white hover:bg-white/20 colorful-hover"
                >
                ...
                <Button
                  ...
                  className="bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500 hover:from-purple-600 hover:via-pink-600 hover:to-blue-600 shadow-xl colorful-hover pulse-color"
                >
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              {recommendations.map((career, index) => (
                <Card key={index} className="relative overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 border-0 matte-glass interactive-card">
                  <div className="absolute top-0 left-0 right-0 h-2 bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500"></div>
                  <div className="absolute top-4 right-4">
                    <Badge className="badge-sunset pulse-color font-bold">
                  ...
                  <CardHeader className="pb-4">
                    <div className="flex items-center space-x-3 mb-3">
                      ...
                      <div>
                        <CardTitle className="text-xl text-white gradient-text font-bold">{career.title}</CardTitle>
                        <div className="flex items-center space-x-2 mt-1">
                          <Badge className="text-xs badge-vibrant">{career.difficulty}</Badge>
                          <Badge className="text-xs badge-ocean">{career.timeToStart}</Badge>
                        </div>
                      </div>
                    </div>
                  ...
                  <CardContent className="space-y-6">
                    <Tabs defaultValue="overview" className="w-full">
                      <TabsList className="grid w-full grid-cols-4 text-xs matte-glass">
                        <TabsTrigger value="overview" className="text-white/80 data-[state=active]:badge-vibrant data-[state=active]:text-white">Overview</TabsTrigger>
                        <TabsTrigger value="roadmap" className="text-white/80 data-[state=active]:badge-ocean data-[state=active]:text-white">Roadmap</TabsTrigger>
                        <TabsTrigger value="courses" className="text-white/80 data-[state=active]:badge-sunset data-[state=active]:text-white">Courses</TabsTrigger>
                        <TabsTrigger value="jobs" className="text-white/80 data-[state=active]:badge-vibrant data-[state=active]:text-white">Jobs</TabsTrigger>
                      </TabsList>
                      
                      <TabsContent value="overview" className="space-y-4 mt-4">
                        {/* Salary & Growth */}
                        <div className="grid grid-cols-2 gap-4">
                          <div className="p-3 matte-glass rounded-lg colorful-hover">
