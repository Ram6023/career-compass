              ...
              <form onSubmit={handleSubmit} className="space-y-10">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        className="h-12 bg-white/20 border-white/30 text-white placeholder:text-white/60 backdrop-blur-sm"
                      />
                    </div>
                  </div>
                  <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    {SKILLS.map((skill) => (
                      <div key={skill} className="flex items-center space-x-3 p-3 border border-white/30 rounded-lg bg-white/10 hover:bg-white/20 backdrop-blur-sm transition-colors hover-glow">
                        <Checkbox
                          id={`skill-${skill}`}
                    ...
                    <div className="flex flex-wrap gap-2">
                      {formData.skills.map((skill) => (
                        <Badge
                          key={skill}
                          variant="secondary"
                          className="cursor-pointer bg-white/20 text-white hover:bg-white/30 transition-colors duration-200 border border-white/30 backdrop-blur-sm"
                          onClick={() => {
                            toggleSkill(skill);
                            toast({
                              title: "Skill removed",
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    {INTERESTS.map((interest) => (
                      <div key={interest} className="flex items-center space-x-3 p-3 border border-white/30 rounded-lg bg-white/10 hover:bg-white/20 backdrop-blur-sm transition-colors hover-glow">
                        <Checkbox
                    ...
                    <div className="flex flex-wrap gap-2">
                      {formData.interests.map((interest) => (
                        <Badge
                          key={interest}
                          variant="outline"
                          className="cursor-pointer border-white/30 text-white hover:bg-white/20 transition-colors duration-200 bg-white/10 backdrop-blur-sm"
                          onClick={() => {
                ...
                <Button
                  type="submit"
                  className="w-full py-6 text-lg bg-white/20 hover:bg-white/30 text-white shadow-lg hover-glow backdrop-blur-sm border border-white/30"
          ...
          <div className="max-w-7xl mx-auto space-y-8">
            <div className="text-center">
              ...
              <div className="flex justify-center space-x-4">
                ...
                <Button
                  ...
                  className="bg-white/20 hover:bg-white/30 text-white shadow-lg hover-glow backdrop-blur-sm border border-white/30"
                >
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              {recommendations.map((career, index) => (
                <Card key={index} className="relative overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 border-0 glass hover-glow">
                  ...
                  <CardHeader className="pb-4">
                    <div className="flex items-center space-x-3 mb-3">
                      ...
                      <div>
                        <CardTitle className="text-xl text-white drop-shadow">{career.title}</CardTitle>
                        <div className="flex items-center space-x-2 mt-1">
                          <Badge variant="outline" className="text-xs bg-white/20 border-white/30 text-white">{career.difficulty}</Badge>
                          <Badge variant="outline" className="text-xs bg-white/20 border-white/30 text-white">{career.timeToStart}</Badge>
                        </div>
                      </div>
                    </div>
                  ...
                  <CardContent className="space-y-6">
                    <Tabs defaultValue="overview" className="w-full">
                      <TabsList className="grid w-full grid-cols-4 text-xs bg-white/20 backdrop-blur-sm">
                        <TabsTrigger value="overview" className="text-white/80 data-[state=active]:bg-white/30 data-[state=active]:text-white">Overview</TabsTrigger>
                        <TabsTrigger value="roadmap" className="text-white/80 data-[state=active]:bg-white/30 data-[state=active]:text-white">Roadmap</TabsTrigger>
                        <TabsTrigger value="courses" className="text-white/80 data-[state=active]:bg-white/30 data-[state=active]:text-white">Courses</TabsTrigger>
                        <TabsTrigger value="jobs" className="text-white/80 data-[state=active]:bg-white/30 data-[state=active]:text-white">Jobs</TabsTrigger>
                      </TabsList>
